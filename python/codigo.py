...
if mostrar_sensibilidad:
    ...
    graficos.graficar_sensibilidad_fg(titulo="Sensibilidad Absoluta FG Tanda 1 (Tasa Absoluta vs $I_D$ Promedio Normalizado)", datos_sensibilidad=sens_abs_t1, xlabel = r"Corriente Promedio Normalizada $I_{D\_norm}$ [$\mu$A]", ylabel = r"Tasa de Cambio Absoluta [$\mu$A/min]")
        
    sens_abs_t2 = proc_sens.procesar_sensibilidad(["PFGIW1", "PFGIW2", "PFGIW3", "PFGIP2"], "FG_tanda2", normalizado=False)
    graficos.graficar_sensibilidad_fg(titulo="Sensibilidad Absoluta FG Tanda 2 (Tasa Absoluta vs $I_D$ Promedio Normalizado)", datos_sensibilidad=sens_abs_t2, xlabel = r"Corriente Promedio Normalizada $I_{D\_norm}$ [$\mu$A]" ylabel = r"Tasa de Cambio Absoluta [$\mu$A/min]")
