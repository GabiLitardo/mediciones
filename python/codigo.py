...
if mostrar_sensibilidad:
    ...
    sens_vg_t1 = proc_sens.procesar_sensibilidad(["PFGIW1", "PFGIW2", "PFGIW3"], "FG_tanda1", n_ventana=6)
    ...
    sens_vg_t2 = proc_sens.procesar_sensibilidad(["PFGIW1", "PFGIW2", "PFGIW3", "PFGIP2"], "FG_tanda2", n_ventana=6)
    graficos.graficar_sensibilidad_vg(
